...
Namespace QueryBuilderProperties
    ...
    Partial Friend Class SqlSyntaxPage
        ...
        Private fModified As Boolean = False
        ...
        Public Sub New(queryBuilder As QueryBuilder, syntaxProvider As BaseSyntaxProvider)
            ...
            comboSqlDialect.Items.Add("Snowlfake")
            ...
            If queryBuilder.SyntaxProvider IsNot Nothing Then
                comboIdentCaseSens.SelectedIndex = CInt(Fix(queryBuilder.SyntaxProvider.IdentCaseSens))
        ...
        Private Sub comboSqlDialect_SelectedIndexChanged(sender As Object, e As EventArgs)
            ...
            comboIdentCaseSens.SelectedIndex = CInt(Fix(_syntaxProvider.IdentCaseSens))
        ...
        Public Sub ApplyChanges()
            If Me.Modified Then
                ...
                _queryBuilder.SQLGenerationOptions.QuoteIdentifiers = If(cbQuoteAllIdentifiers.Checked, IdentQuotation.All, IdentQuotation.IfNeed)
                _queryBuilder.SQLFormattingOptions.QuoteIdentifiers = If(cbQuoteAllIdentifiers.Checked, IdentQuotation.All, IdentQuotation.IfNeed)
