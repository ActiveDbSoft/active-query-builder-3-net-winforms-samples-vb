...
Namespace Forms
    Partial Public Class EditUserPredefinedConditionsForm
        ...
        Private _cancelWithoutSave As Boolean
        ...
        Private Function SaveForm() As Boolean
            Try
                ...
                Dim result = _queryView.Query.SQLContext.ParseLogicalExpression(TextBoxCondition.Text, False, False, token)
                If result Is Nothing AndAlso token IsNot Nothing Then
                    Throw New SQLParsingException(String.Format(Helpers.Localizer.GetString(NameOf(LocalizableConstantsUI.strInvalidCondition), LocalizableConstantsUI.strInvalidCondition), TextBoxCondition.Text), token)
                End If
            ...
            Dim userExpression = New PredefinedCondition(TextBoxCaption.Text, listTypes, TextBoxCondition.Text, CheckBoxIsNeedEdit.Checked)
        ...
        Private Sub TextBoxExpression_TextChanged(sender As Object, e As EventArgs) Handles TextBoxCondition.TextChanged
            CheckChangingItem()
        End Sub
        ...
        Private Sub CheckChangingItem()
            If _selectedPredefinedCondition Is Nothing Then
                buttonSave.Enabled = Not String.IsNullOrEmpty(TextBoxCaption.Text) AndAlso Not String.IsNullOrEmpty(TextBoxCondition.Text)
        ...
        Protected Overrides Sub OnClosing(e As CancelEventArgs)
            If buttonSave.Enabled And Not _cancelWithoutSave Then
                Dim result As DialogResult = MessageBox.Show("Save changes to the current condition?",
