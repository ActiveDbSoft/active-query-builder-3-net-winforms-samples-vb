...
Public Class Options
    ...
    Public Shared Sub SerializeOptions(path As String, dbView As DatabaseSchemaView, withOptions As ISupportOptions)
    ...
    Public Shared Sub DeserializeOptions(xml As String, dbView As DatabaseSchemaView, withOptions As ISupportOptions)
        Dim buffer = Encoding.UTF8.GetBytes(xml)
        Using memoryStream = New MemoryStream(buffer)
            Dim adapter = New XmlAdapter(memoryStream)
            Dim service = New OptionsDeserializationService(adapter)
