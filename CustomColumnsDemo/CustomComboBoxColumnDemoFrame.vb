...
Partial Public Class CustomComboBoxColumnDemoFrame
    Inherits UserControl
    Private _customColumn As DataGridViewComboBoxColumn
    ...
    Private Sub queryBuilder1_QueryElementControlCreated(ByVal queryElement As QueryElement, ByVal queryElementControl As IQueryElementControl) Handles queryBuilder1.QueryElementControlCreated
        If TypeOf queryElementControl Is IQueryColumnListControl Then
            ...
            _customColumn = New DataGridViewComboBoxColumn With {.Name = "CustomColumn", .HeaderText = "Custom Column", .Width = 200, .DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing, .ValueType = GetType(String)}
    ...
    Private Sub DataGridView_CellEnter(ByVal sender As Object, ByVal e As DataGridViewCellEventArgs)
        ...
        If grid.Columns(e.ColumnIndex) IsNot _customColumn Then
            Return
        End If
