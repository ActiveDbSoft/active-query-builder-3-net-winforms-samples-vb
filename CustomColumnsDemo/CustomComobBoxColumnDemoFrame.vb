...
Partial Public Class CustomComobBoxColumnDemoFrame
    ...
    Private Sub queryBuilder1_QueryElementControlCreated(queryElement As QueryElement, queryElementControl As IQueryElementControl)
        If TypeOf queryElementControl Is IQueryColumnListControl Then
            ...
            _customColumn = New DataGridViewComboBoxColumn With {
                .Name = "CustomColumn",
                .HeaderText = "Custom Column",
                .Width = 200,
                .DisplayStyle = DataGridViewComboBoxDisplayStyle.[Nothing], ' hide the comboox if cell is not focused
