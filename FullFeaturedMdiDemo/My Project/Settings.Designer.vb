...
Namespace My
	...
	Friend NotInheritable Partial Class Settings
		...
		<Global.System.Configuration.UserScopedSettingAttribute(), Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.Configuration.DefaultSettingValueAttribute("0, 0, 0, 0")>
		...
		Public Property Connections() As Global.ConnectionList
			Get
				Return (CType(Me("Connections"), Global.ConnectionList))
			End Get
		...
		Public Property XmlFiles() As Global.ConnectionList
			Get
				Return (CType(Me("XmlFiles"), Global.ConnectionList))
			End Get
			Set(value As ConnectionList)
				Me("XmlFiles") = value
			End Set
