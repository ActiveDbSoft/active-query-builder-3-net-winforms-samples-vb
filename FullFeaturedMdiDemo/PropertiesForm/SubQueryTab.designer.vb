...
'			Me.chBxSubQueriesFromNewLines.CheckedChanged += New System.EventHandler(Me.chBxSubQueriesFromNewLines_CheckedChanged)
			...
			Me.label2.Location = New Point(508, 16)
			Me.label2.Name = "label2"
			Me.label2.Size = New Size(243, 26)
			Me.label2.TabIndex = 2
			Me.label2.Text = "Sub-Queries format options determine the " & vbCrLf & "layout of sub-queries used in expressi" & "ons of query."
			' 
