...
Partial Public Class ConnectionForm
    ...
    Private Sub btnAdd_Click(ByVal sender As Object, e As EventArgs) Handles btnAdd.Click
    ...
    Private Sub btnRemove_Click(ByVal sender As Object, e As EventArgs) Handles btnRemove.Click
    ...
    Private Sub btnConfigure_Click(ByVal sender As Object, e As EventArgs) Handles btnConfigure.Click
        If lvConnections.SelectedItems.Count > 0 Then
            Dim ci As ConnectionInfo = CType(lvConnections.SelectedItems(0).Tag, ConnectionInfo)
    ...
    Private Sub lvConnections_SizeChanged(ByVal sender As Object, e As EventArgs) Handles lvConnections.SizeChanged
        lvConnections.Columns(0).Width = lvConnections.Width - lvConnections.Columns(1).Width - SystemInformation.VerticalScrollBarWidth
    End Sub

    Private Sub lvXmlFiles_SizeChanged(ByVal sender As Object, e As EventArgs) Handles lvXmlFiles.SizeChanged
        lvXmlFiles.Columns(0).Width = lvXmlFiles.Width - lvXmlFiles.Columns(1).Width - SystemInformation.VerticalScrollBarWidth
    End Sub

    Private Sub Application_Idle(ByVal sender As Object, e As EventArgs)
    ...
    Private Sub lvConnections_MouseDoubleClick(ByVal sender As Object, e As MouseEventArgs) Handles lvConnections.MouseDoubleClick
        DialogResult = DialogResult.OK
        Close()
    End Sub

    Private Sub lvXmlFiles_MouseDoubleClick(ByVal sender As Object, e As MouseEventArgs) Handles lvXmlFiles.MouseDoubleClick
        DialogResult = DialogResult.OK
        Close()
    End Sub

    Private Sub btnAddXml_Click(ByVal sender As Object, e As EventArgs) Handles btnAddXml.Click
    ...
    Private Sub btnRemoveXml_Click(ByVal sender As Object, e As EventArgs) Handles btnRemoveXml.Click
    ...
    Private Sub btnConfigureXml_Click(ByVal sender As Object, e As EventArgs) Handles btnConfigureXml.Click
        If lvXmlFiles.SelectedItems.Count > 0 Then
            Dim ci As ConnectionInfo = CType(lvXmlFiles.SelectedItems(0).Tag, ConnectionInfo)
