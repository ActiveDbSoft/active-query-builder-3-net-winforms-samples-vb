Partial Class Form1
	...
	Private Sub InitializeComponent()
		...
		' 
		Me.postgreSQLSyntaxProvider1.ComparisonOperators = DirectCast(resources.GetObject("postgreSQLSyntaxProvider1.ComparisonOperators"), System.Collections.Generic.List(Of String))
