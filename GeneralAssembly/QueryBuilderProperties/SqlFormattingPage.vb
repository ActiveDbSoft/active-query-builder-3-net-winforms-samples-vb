...
Namespace QueryBuilderProperties
    ...
    Partial Friend Class SqlFormattingPage
        ...
        Private _page As SqlBuilderOptionsPages = SqlBuilderOptionsPages.MainQuery
        Private _queryBuilder As QueryBuilder = Nothing
        Private _format As SQLBuilderSelectFormat
        ...
        Public Sub ApplyChanges()
            If Modified Then
                ...
                _format.IndentInPart = CInt(Fix(updownPartIndent.Value))
                _format.IndentGlobal = CInt(Fix(updownGlobalIndent.Value))
                ...
                _format.WhereFormat.IndentNestedConditions = CInt(Fix(updownWhereIndent.Value))
                ...
                _format.HavingFormat.IndentNestedConditions = CInt(Fix(updownHavingIndent.Value))
